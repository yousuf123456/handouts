...
export const SubmitRequest: React.FC<SubmitRequestProps> = ({
  ...
  const disabled = !isAgreedToPolicies || !selectedOrderedProducts.length || reasonNotGiven.length > 0

  return (
    <div className='w-full flex justify-end'>
      <LoadingButton onClick={onClick} disabled={isLoading || disabled} isLoading={isLoading}>
        Submit Request
      </LoadingButton>
    </div>
  )
