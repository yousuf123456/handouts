...
export default function FeaturedImageBanner({
  ...
  // if (!data.banner || !data.heading || !data.description) return;

  return (
    <Module moduleHeading="Featured Image Banner">
      <div
        className={clsx(
      ...
      >
        <div
          className={clsx(
            ...
            "min-[520px]:aspect-3 md:col-span-4 lg:col-span-3",
          )}
        >
          {data.banner ? (
            <Image
          ...
          <div className=" flex flex-col justify-start gap-3">
            <h1
              className={clsx(
                ...
                "left-3 top-3 bg-black bg-opacity-60 px-1 min-[420px]:text-base md:static md:bg-transparent md:bg-opacity-100 md:px-0 md:text-lg md:text-themeSecondary lg:text-xl",
              )}
            >
              Main Heading Here
            </h1>
