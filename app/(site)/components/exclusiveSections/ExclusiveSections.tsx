...
export const ExclusiveSections = () => {
    ...
    const chevronClassName = "z-50 w-6 h-full sm:w-8 cursor-pointer min-[900px]:hidden flex justify-center items-center transition-all bg-themeSecondary bg-opacity-30 hover:bg-opacity-60 text-white font-bold"
    ...
    const renderArrowNext = (
        ...
        label : string
            ...
            <HiChevronRight 
                className={clsx('absolute top-1/2 -translate-y-1/2 right-0', chevronClassName)} 
                onClick={clickHandler}
            />
  ...
  return (
    <div className='flex flex-col gap-1'>
        <Heading>
            Explore Our Exclusive Sections
        </Heading>
        
        <div className='relative'>
            <div id='cards-cont' className='relative hidden min-[900px]:grid min-[900px]:grid-cols-3 overflow-hidden gap-4 scrollbar-none'>
                {
